...
// exit        exits the test client
// add INT     adds the INT to the minheap
// top         prints the top of the minheap
// print       prints the array for the minheap
// remove      prints and removes the top of the minheap

// sort N INT_0 INT_1 ... INT_N-1   sorts N numbers 
