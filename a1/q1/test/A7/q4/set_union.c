...
int main(void) {
  ...
  struct set * r1 = set_union(set1, set2);
  struct set * r2 = set_union(set2, set3);
  struct set * r3 = set_union(set1, set3);

  assert(set_equal(r1, set4));
  assert(set_equal(r2, set5));

  assert(!set_equal(r1, r3));
